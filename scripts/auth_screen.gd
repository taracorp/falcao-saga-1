...
@onready var username_input = $CenterContainer/VBox/UsernameInput
@onready var email_input = $CenterContainer/VBox/EmailInput
@onready var password_input = $CenterContainer/VBox/PasswordInput
@onready var error_label = $CenterContainer/VBox/ErrorLabel
@onready var loading = $LoadingIndicator

func _ready() -> void:
	$CenterContainer/VBox/SignInButton.pressed.connect(_on_sign_in)
	$CenterContainer/VBox/SignUpButton.pressed.connect(_on_sign_up)
	$CenterContainer/VBox/SkipButton.pressed.connect(_on_skip)
