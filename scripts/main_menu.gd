...
@onready var coins_label = $VBox/TopBar/CoinsLabel
@onready var xp_label = $VBox/TopBar/XPLabel
@onready var rpp_label = $VBox/TopBar/RPPLabel
@onready var lives_label = $VBox/TopBar/LivesLabel
@onready var season_info = $VBox/SeasonInfo
...
func _connect_signals() -> void:
	...
	$VBox/AlbumButton.pressed.connect(_on_album_pressed)
	$VBox/ShopButton.pressed.connect(_on_shop_pressed)
	$VBox/LeaderboardButton.pressed.connect(_on_leaderboard_pressed)
